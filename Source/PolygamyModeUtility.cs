...
namespace OneBedToSleepWithAll
{
    public class PolygamyModeUtility
    {
        ...
        public static bool AddMakeMasterButton(Rect rect, System.Object pawn_raw, ThingWithComps parent, bool isRectFull)
        {
            Pawn pawn;
            if (pawn_raw is Pawn)
            {
            ...
            if (Widgets.ButtonText(rect, "polygamyMode_MakeAMaster".Translate(), true, true, accepted, null))
            {
